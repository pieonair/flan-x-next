        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                    required={true}
                    type="text"
                    placeholder="i.e. Saved List does not work, External Links do not work"
                ...
                <input
                    required={true}
                    type="text"
                    placeholder="i.e. 1. Main info page 2. Click external link 3. XXX failed to work"
                    {...register("steps")}
                />
                <div>Screenshots*</div>
                ...
                <label htmlFor="consent">
                    I give Flan consent to access my account, for developers to
